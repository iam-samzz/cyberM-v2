...
const resources = [
  { type:"article", title:"OWASP Top 10 — 2024 Breakdown", desc:"Detailed analysis of the most critical web application security risks.", source:"OWASP", link:"https://owasp.org/Top10/", date:"2024" },
  { type:"video", title:"Network Fundamentals for Security", desc:"Complete networking basics every security professional must know.", source:"NetworkChuck", link:"https://www.youtube.com/results?search_query=networking+for+cyber+security", date:"2024" },
  { type:"blog", title:"Krebs on Security", desc:"In-depth security news and investigation from veteran journalist Brian Krebs.", source:"Krebs", link:"https://krebsonsecurity.com/", date:"Ongoing" },
  { type:"article", title:"NIST Cybersecurity Framework", desc:"The standard framework for improving critical infrastructure cybersecurity.", source:"NIST", link:"https://www.nist.gov/cyberframework", date:"2024" },
  { type:"video", title:"Ethical Hacking Full Course", desc:"12-hour comprehensive ethical hacking course covering all major topics.", source:"freeCodeCamp", link:"https://www.youtube.com/results?search_query=ethical+hacking+full+course", date:"2024" },
  { type:"blog", title:"The Hacker News", desc:"Leading cybersecurity news source covering latest threats and vulnerabilities.", source:"THN", link:"https://thehackernews.com/", date:"Ongoing" },
  { type:"article", title:"MITRE ATT&CK Framework", desc:"Knowledge base of adversary tactics and techniques based on real observations.", source:"MITRE", link:"https://attack.mitre.org/", date:"2024" },
  { type:"video", title:"TryHackMe — Guided Learning", desc:"Hands-on cybersecurity training through browser-based labs and challenges.", source:"TryHackMe", link:"https://tryhackme.com/", date:"Ongoing" },
  { type:"blog", title:"Schneier on Security", desc:"Security thoughts and analysis from cryptographer Bruce Schneier.", source:"Schneier", link:"https://www.schneier.com/", date:"Ongoing" },
  { type:"article", title:"SANS Cyber Security Resources", desc:"Free resources, research papers, and security guides from SANS Institute.", source:"SANS", link:"https://www.sans.org/free-resources/", date:"Ongoing" },
  { type:"video", title:"Cybersecurity Basics — IBM", desc:"Introduction to cybersecurity concepts, threats, and defense strategies.", source:"IBM", link:"https://www.youtube.com/results?search_query=cybersecurity+basics+ibm", date:"2024" },
  { type:"blog", title:"Dark Reading", desc:"Cybersecurity news, analysis, and insights for security professionals.", source:"DarkReading", link:"https://www.darkreading.com/", date:"Ongoing" },
];
